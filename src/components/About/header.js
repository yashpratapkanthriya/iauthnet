                    ...
                    <div className="collapse navbar-collapse order-2 order-lg-1" id="navbarSupportedContent">
                        <form className="form-inline my-2 my-lg-0">
                            <input className="form-control mr-sm-2" type="search" placeholder="Search Listings"
                                   aria-label="Search" onChange={this.handleChange} value={this.state.searchQuery}/>
                        </form>
                        <div className="navbar-nav justify-content-end">
                            ...
                            <Link to="/create" className="nav-item nav-link"><img src="/images/add-listing-icon.svg"
                                                                                  alt="Add Listing"
                                                                                  className="add-listing"/>Add
                                Listing</Link>
                        </div>
                    </div>
                    <div className="static navbar-nav order-1 order-lg-2">
                        <div className="nav-item notifications dropdown">
                            <a className="nav-link active dropdown-toggle" id="notificationsDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div className="unread-badge"></div>
                                <img src="/images/alerts-icon.svg" className="notifications" alt="Notifications"/>
                                <img src="/images/alerts-icon-selected.svg" className="notifications selected"
                                     alt="Notifications"/>
                            </a>
                                    ...
                                    <div className="notifications-list">
                                        <ul className="list-group">
                                            {data.notifications.map(n => <Notification
                                                key={`navbar-notification-${n._id}`} notification={n}/>)}
                                        </ul>
                                    </div>
                                    <footer>
                        ...
                        <div className="nav-item identity dropdown">
                            <a className="nav-link active dropdown-toggle" id="identityDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div className="wallet">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p><Link
                                                    to="/profile"><strong>0x32Be343B94f860124dC4fEe278FDCBD38C102D88</strong></Link>
                                                </p>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div className="d-flex">
                                            <div className="avatar-container">
                                                <Link to="/profile"><img src="/images/avatar-blue.svg"
                                                                         alt="avatar"/></Link>
                                            </div>
                                            <div className="identification">
                                                <p><Link to="/profile">Aure Gimon</Link></p>
                                                <Link to="/profile"><img src="/images/twitter-icon-verified.svg"
                                                                         alt="Twitter verified icon"/></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
