                ...
                <div className="row">
                    <div className="col-12 col-md-6">
                        ...
                        <p className="company-mission">
                            Origin is building the sharing economy of tomorrow. Buyers and sellers will be able to
                            transact without rent-seeking middlemen. We believe in lowering transaction fees, reducing
                            censorship and regulation, and giving early participants in the community a stake in the
                            network.
                        </p>
                        <p>
                        ...
                        <div className="row">
                            ...
                            <div className="col-6 col-md-4">
                                ...
                                <ul className="footer-links">
                                    ...
                                    <li>
                                        <a href="https://www.google.com/maps/place/845+Market+St+%23450a,+San+Francisco,+CA+94103">845
                                            Market St, #450A, San Francisco, CA 94103</a>
                                    </li>
                                    <li>
